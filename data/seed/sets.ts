 ...
 *
 * marketStatus 결정 기준 (2026-05-14 기준):
 *   - DISCONTINUED: 공식 유통 종료, P2P/리세일 위주 (절판)
 *   - ACTIVE: 현역 판매 중 (소매점 정상 입고)
 *   - PRE_RELEASE: 발매 전 예약 단계
 */
...
export const cardSets: CardSet[] = [
  ...
  // ===== 크림슨헤이즈 (2024, 절판) =====
  {
    ...
    packsPerBox: 30, cardsPerPack: 5, msrpKRW: 117000, isActive: false,
    era: "2024", seriesGroup: "SV_REGULAR", marketStatus: "DISCONTINUED",
